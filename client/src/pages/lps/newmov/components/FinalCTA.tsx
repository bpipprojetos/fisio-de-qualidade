...
const freedomImage = "/assets/images/newmov/freedom-newmov.jpg";
...
const FinalCTA = () => {
  return (
    <section className="relative overflow-hidden min-h-[70vh] flex items-center">
      ...
      >
        <img src={freedomImage} alt="Liberdade e vida sem dor" loading="lazy" className="w-full h-full object-cover" />
      ...
      <div className="relative container mx-auto px-4 py-20 md:py-32 text-center">
        ...
        >
          ...
          <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-white leading-tight text-balance">
            Cada dia com dor é um dia a menos vivendo de verdade.
          </motion.h2>
          <motion.p variants={fadeInUp} className="text-xl md:text-2xl text-white/80">
          ...
          <motion.p variants={fadeInUp} className="text-sm text-white/50 pt-2">

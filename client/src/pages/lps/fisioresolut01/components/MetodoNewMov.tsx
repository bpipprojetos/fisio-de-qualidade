...
// Asset paths
const metodoDorImage = "/assets/images/fisioresolut01/metodo-dor.jpg";
const metodoAtletasImage = "/assets/images/fisioresolut01/metodo-atletas.jpg";
const metodoPosturalImage = "/assets/images/fisioresolut01/metodo-postural.jpg";
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <motion.h2 variants={fadeInUp} className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-foreground text-balance">
              O <span className="text-primary">Método FisioResolut</span>: Padrão Ouro + Tecnologia de Ponta
            </motion.h2>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="flex flex-wrap gap-3 pt-2">
                {["Terapia Manual", "Osteopatia", "Quiropraxia", "Modulação da Dor", "Musculação Terapêutica", "Laser", "Manta de LED", "Cluster de Laser", "Ondas de Choque", "Eletrotermofototerapia"].map((tag) => (
            ...
            >
              <img src={metodoDorImage} alt="Tratamento especializado para dor crônica com equipamentos modernos" className="w-full h-auto" loading="lazy" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
            ...
            >
              <img src={metodoAtletasImage} alt="Atleta em processo de reabilitação e otimização de performance" className="w-full h-auto" loading="lazy" />
            </motion.div>
            <motion.div
              initial="hidden"
              whileInView="visible"
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="flex flex-wrap gap-3 pt-2">
                {["Alta Performance", "Biomecânica", "Recuperação Esportiva", "Força & Potência", "Prevenção de Lesões", "Dinamometria"].map((tag) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              className="rounded-2xl overflow-hidden shadow-xl"
            >
              <img src={metodoPosturalImage} alt="Avaliação postural criteriosa para correção de escoliose e desvios" className="w-full h-auto" loading="lazy" />
            </motion.div>
          </div>
        </div>
      </section>

...
const StarRating = () => (
  <div className="flex gap-0.5">
    {[...Array(5)].map((_, i) => (
      <Star key={i} className="w-4 h-4 fill-itc-gold text-itc-gold" />
    ))}
  </div>
);
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-3 bg-background border border-border rounded-xl px-6 py-4 shadow-sm">
            ...
            <div className="ml-2 flex items-center gap-1 bg-itc-green/10 text-itc-green px-3 py-1 rounded-full text-xs font-semibold">
